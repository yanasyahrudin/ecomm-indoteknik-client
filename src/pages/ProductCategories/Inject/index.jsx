...
const ProductList = () => {
  ...
  const getCategoryOne = async () => {
    try {
      const response = await axios.get(`${API_URL}/products/inject`);
    ...
    <>
      <div className="categotyListed">
        <img
          ...
          src="https://res.cloudinary.com/dcbryptkx/image/upload/v1694142746/IndoTeknikMarketplace/product/banner/Banner%20Kategori/Injector_pkzsfp.jpg"
          alt=""
        />
        <h3 style={{textAlign: 'center'}} className="productlist-title">Injector</h3>
